...
class GumballMachineTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testInsertC()
    {
       ...
       $this->assertContents("good job",$this->gumballMachineInstance->InsertC($this->intitule,$this->duree,$this->gumballMachineInstance->GetIdP("XXX2" ,"YYY2")));
       $this->assertContents("good job",$this->gumballMachineInstance->InsertC($this->intitule1,$this->duree1,$this->gumballMachineInstance->GetIdP("XX1" ,"YYY1")));
       $this->assertContents("good job",$this->gumballMachineInstance->InsertC($this->intitule2,$this->duree2,$this->gumballMachineInstance->GetIdP("XXX3" ,"YYY3")));
